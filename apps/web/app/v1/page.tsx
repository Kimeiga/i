...
export const metadata: Metadata = {
  title: 'Landing page v1 (archived)',
...
/**
 * The first landing page, preserved verbatim at /v1 so the rewrite can be
 * compared against something rather than asserted to be better.
 *
 * Do not edit this file. It is a snapshot of commit db780e5. If it needs to
 * change, the comparison it exists for has already been lost.
 */
